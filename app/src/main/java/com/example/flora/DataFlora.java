...
import java.util.List;
    ...
    public class DataFlora extends AppCompatActivity implements AdapterView.OnItemClickListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            for (flora cn : contacts) {
                ...
                if ((ListFlora.isEmpty()))
                    Toast.makeText(DataFlora.this, "Tidak ada data",
...
//            Fragment selectetdFragment = null;
                ...
                switch (menuItem.getItemId()){
                    case R.id.menu_flora:
                        Intent b = new Intent(DataFlora.this, DataFlora.class);
                        startActivity(b);
                        break;
                    case R.id.menu_add:
                        Intent a = new Intent(DataFlora.this, AddFlora.class);
                        startActivity(a);
                        break;
                    case R.id.menu_about:
                        Intent c = new Intent(DataFlora.this, About.class);
                        startActivity(c);
                        break;
                }
        ...
        public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
            ...
            Intent goUpdel = new Intent(DataFlora.this, UpDelFlora.class);
